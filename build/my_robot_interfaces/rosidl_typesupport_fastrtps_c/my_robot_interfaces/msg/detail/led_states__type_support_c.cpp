...
bool cdr_serialize_my_robot_interfaces__msg__LedStates(
  const my_robot_interfaces__msg__LedStates * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_deserialize_my_robot_interfaces__msg__LedStates(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces__msg__LedStates * ros_message)
{
  // Field name: led_states
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_serialize_key_my_robot_interfaces__msg__LedStates(
  const my_robot_interfaces__msg__LedStates * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: led_states
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t get_serialized_size_key_my_robot_interfaces__msg__LedStates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LedStates__ros_msg_type * ros_message = static_cast<const _LedStates__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_key_my_robot_interfaces__msg__LedStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_robot_interfaces__msg__LedStates * ros_message = static_cast<const my_robot_interfaces__msg__LedStates *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_robot_interfaces__msg__LedStates(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_robot_interfaces__msg__LedStates * ros_message = static_cast<my_robot_interfaces__msg__LedStates *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_robot_interfaces__msg__LedStates(cdr, ros_message);
}
